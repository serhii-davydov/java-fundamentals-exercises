...
//        throw new ExerciseNotCompletedException(); // todo:
    ...
    /**
     * Create a connection between first and second nodes, so object first stores a reference to
     * the second.
     *
...
//        throw new ExerciseNotCompletedException(); // todo:
    ...
    /**
     * Creates two new {@link Node} objects using provided firstElement and secondElement, and
     * create a connection
...
//        throw new ExerciseNotCompletedException(); // todo:
     ...
     * Creates two new {@link Node} objects using provided firstElement and secondElement, and
     * creates connections
     * between those nodes so the first node will hold a reference to a second one, and a second
     * node will hold
...
//        throw new ExerciseNotCompletedException(); // todo:
    ...
    /**
     * Creates a linked chain of {@link Node} objects based on provided elements. Creates a
     * connection between those
     * nodes so each node will hold a reference to the next one in the chain. HINT: it's
...
//        throw new ExerciseNotCompletedException(); // todo:
    ...
    /**
     * Creates a linked circle of {@link Node} objects based on provided elements. Creates a
     * connection between those
     * nodes so each node will hold a reference to the next one in the chain, and the last one
