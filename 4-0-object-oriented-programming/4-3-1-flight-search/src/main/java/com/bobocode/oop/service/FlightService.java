 ...
 * <p>
 * todo: 1. Using {@link com.bobocode.oop.data.FlightDao} implement method
 * {@link FlightService#registerFlight(String)}
 * todo: 2. Using {@link com.bobocode.oop.data.FlightDao} implement method
...
//        throw new ExerciseNotCompletedException();
    ...
    public List<String> searchFlights(String query) {
        return flightDao.findAll().stream().filter(e -> e.contains(query))
